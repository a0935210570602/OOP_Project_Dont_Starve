var MyMenu = Framework.exClass(Framework.GameMainMenu , {
    ...
    draw: function(parentCtx) { 
        ...
        parentCtx.fillStyle = 'gold';
        parentCtx.textBaseline = 'top';
        parentCtx.textAlign = 'center';
        parentCtx.fillText('開始遊戲', this.rectPosition.x + 530, this.rectPosition.y+500, 260);

        parentCtx.font = '30pt bold';
        parentCtx.fillStyle = 'gold';
        parentCtx.textBaseline = 'top';
        parentCtx.textAlign = 'center';
        parentCtx.fillText('遊戲教學', this.rectPosition.x + 530, this.rectPosition.y+560, 260);

        parentCtx.font = '30pt bold';
        parentCtx.fillStyle = 'gold';
        parentCtx.textBaseline = 'top';
        parentCtx.textAlign = 'center';
        parentCtx.fillText('結束遊戲', this.rectPosition.x + 530, this.rectPosition.y+620, 260);

        parentCtx.font = '30pt bold';
        parentCtx.fillStyle = 'gold';
        parentCtx.textBaseline = 'top';
        parentCtx.textAlign = 'center';
        parentCtx.fillText('遊戲團隊', this.rectPosition.x + 530, this.rectPosition.y+680, 260);
    },
